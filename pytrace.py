...
class Trace:
    ...
    def run(self, cmd, fn_dict={}):
        import __main__
        dict_ = __main__.__dict__
        if fn_dict:
            dict_.update(fn_dict)
        self.runctx(cmd, dict_, dict_)
        ...
        if why == 'call':
            ...
            if filename:
                ...
                if modulename is not None:
                    ...
                    if not ignore_it:
                        if self.trace:
                            global_output.append((" --- modulename: %s, funcname: %s"
    ...
    def localtrace_trace(self, frame, why, arg):
        ...
        if why == "line":
            ...
            bname = os.path.basename(filename)
            global_output.append("%s(%d): %s" % (bname, lineno,
